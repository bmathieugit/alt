...
alt::test::TestDefinition operator""_test(const char *descr, long unsigned int n)
{
  return {{descr, descr + n}};
}

alt::test::TestSuiteDefinition operator""_suite(const char *descr, long unsigned int n)
{
  return {{descr, descr + n}};
}

namespace alt::test::is
{
  struct Equals
  {
